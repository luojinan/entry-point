...
class QupansouPlugin extends BasePlugin {
  ...
  private _determineLinkType(url: string): CloudType {
    ...
    if (lowerURL.includes("aliyundrive.com") || lowerURL.includes("alipan.com"))
      return "aliyun";
    ...
    if (
      lowerURL.includes("caiyun.139.com") ||
      lowerURL.includes("www.caiyun.139.com")
    )
      return "mobile";
    if (lowerURL.includes("115.com")) return "115";
    if (lowerURL.includes("drive.uc.cn")) return "uc";
    if (lowerURL.includes("pan.123.com") || lowerURL.includes("123pan.com"))
      return "123";
    if (lowerURL.includes("mypikpak.com")) return "pikpak";
    if (lowerURL.includes("lanzou")) return "others"; // lanzou没有在CloudType中定义，使用others
    return "others";
  }

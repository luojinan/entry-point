...
const linkPatterns: Array<{ reg: RegExp; typ: CloudType | "magnet" }> = [
...
class MikuclubPlugin extends BasePlugin {
   ...
   */
  async _fetchCategoryPosts(keyword: string, catID: string): Promise<any[]> {

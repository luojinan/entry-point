...
class Yunsou extends BasePlugin {
  ...
  _convertToSearchResult(item) {
    ...
    if (item.times) {
      ...
      result.datetime = isNaN(d.getTime()) ? new Date() : d;
    } else {
  ...
  _convertNetDiskType(isType) {
    switch (isType) {
      case 0: return 'quark';
      case 1: return 'aliyun';
      case 2: return 'baidu';
      case 3: return 'uc';
      case 4: return 'xunlei';
      default: return 'others';
    }
  }

  _extractPwdFromURL(urlStr) {
    const matches = urlStr.match(PWD_PARAM_REGEX);
    return matches ? matches[1] : '';
  }
}

module.exports = Yunsou;
